/******************* Final Collections Challenge README ********************/
 ...
 * Items can continue to be added to the basket, but it should not be possible to reserve more than the available stock of any item. An item's available stock is the stock count less the reserved amount. 
